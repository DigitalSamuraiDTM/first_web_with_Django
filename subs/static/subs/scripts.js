...
var main_choice_quest = 0, anxiety_in_school = 0, social_fear = 0, frustration = 0, fear_self_expressions = 0,
    fear_situation_to_check = 0;
var progress_bar = 0, percent_test = 1, width_main_choice_quest_bar, width_anxiety_in_school_bar, width_social_fear_bar,
    width_frustration_bar, width_fear_self_expression_bar,
...
function give_results_filips() {
    ...
    if (problems_and_fears_with_teachers >= 50 && problems_and_fears_with_teachers < 75) {
        ...
        if (problems_and_fears_with_teachers > 75 && problems_and_fears_with_teachers < 90) {
            ...
            if (problems_and_fears_with_teachers >= 90) {
...
function test_filips() {
    ...
    switch (number_quest) {
        ...
        case 58:
            ...
            login = document.getElementById('username_main_login').value;
            ...
            if (login != '0') {
                ...
                document.getElementById('main_choice_quest').value = (main_choice_quest * 1.72).toFixed(1);
                document.getElementById('fear_not_waiting_social').value = (fear_not_waiting_social*20).toFixed(1);
                document.getElementById('social_fear').value = (social_fear * 9.09).toFixed(1);
                document.getElementById('problems_and_fears_with_teachers').value = (problems_and_fears_with_teachers*12.5).toFixed(1);
                document.getElementById('frustration').value = (frustration * 7.69).toFixed(1);
                document.getElementById('low_resistance_stress').value = (low_resistance_stress*20).toFixed(1);
                document.getElementById('fear_self_expressions').value = (fear_self_expressions*16.67).toFixed(1);
                document.getElementById('fear_situation_to_check').value = (fear_situation_to_check*16.67).toFixed(1);
                document.getElementById('anxiety_in_school').value = (anxiety_in_school * 4.54).toFixed(1);
